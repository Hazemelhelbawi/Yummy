...
var row = document.getElementById("dataInfo");
...
function displayCategories() {
  ...
  for (var i = 0; i < arr.length; i++)
    e += `
    <div class="col-md-6 col-lg-3 my-3 info shadow">
...
function displayMeal(meal) {
  ...
  let str = `
    <div class="col-md-4 info text-white">
					<img class="w-100" src="${meal.strMealThumb}" alt=""
						srcset=""><br>
					<h1>${meal.strMeal}</h1>
				</div>
				<div class="col-md-8 info text-white text-left">
...
$(".nav-item a").click(async (e) => {
  ...
  if (listBy == "contact") {
    row.innerHTML = `
        <section id="contact" class="container info w-75 mx-auto mb-5 ">
		<div class="p-2">
  ...
  document.querySelector(".navMenu").dispatchEvent(click_event);
...
$(document).scroll((e) => {
  if ($(document).scrollTop()) {
    $(".info-media").css("backgroundColor", "#0D0D0D");
  }
});
